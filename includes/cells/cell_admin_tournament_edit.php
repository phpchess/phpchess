...
<h2><?php echo _T('IDS_Admin_Tournament_Edit_UPDATE', $config); ?></h2>
...
?>
	...
	<input name="update" type="submit" value="<?php echo _T('IDS_Form_Button_UPDATE', $config); ?>" /><input name="cancel" type="button" value="<?php echo _T('IDS_Form_Button_BACK', $config); ?>" onclick="window.location.href='chess_tournament_v2.php'"/>
</form>
