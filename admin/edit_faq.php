<?php
  ...
  $Contentpage = "cell_admin_edit_faq.php";  
  ...
  {
	echo "content";
	file_put_contents($Root_Path . 'includes/faq_custom.html', $_POST['content']);
	exit();
  }
  ...
  if(file_exists($Root_Path . 'includes/faq_custom.html'))
	...
	$faq_content = file_get_contents($Root_Path . 'includes/faq.html');
...
<html>
<head>
<title><?php echo __l('Edit FAQ');?></title>
